...
{
   return !preg_match("[^0-9]", $valeur); // il faut remplace ereg par preg_match (ereg obselete)
}
...
{
   return !preg_match("[^a-zA-Z0-9]", $valeur); // il faut remplacer ereg par preg_match
}
